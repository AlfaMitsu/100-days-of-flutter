  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        SvgPicture.asset('lib/src/resources/assets/svg/heading_advanced.svg'),
        const Expanded(
          flex: 5,
          child: SizedBox(),
        ),
        SvgPicture.asset(
            'lib/src/resources/assets/svg/text_adjacent_buttons.svg'),
        ...
        SvgPicture.asset(
            'lib/src/resources/assets/svg/text_config_buttons.svg'),
        const SizedBox(height: 20),
