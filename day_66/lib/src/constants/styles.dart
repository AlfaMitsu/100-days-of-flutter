...
const kSpecialForYouTextStyle = TextStyle(
  fontSize: 25,
  fontWeight: FontWeight.w800,
);

const kSuccessfullyAddedTextStyle = TextStyle(
  fontSize: 25,
  fontWeight: FontWeight.bold,
...
const kCategoryListTitleTextStyle = TextStyle(
  fontWeight: FontWeight.bold,
  fontSize: 16,
);

const kJobStatusTextStyle = TextStyle(
  fontWeight: FontWeight.w800,
  fontSize: 16,
  color: Colors.black54,
);

const kFollowTextStyle = TextStyle(
  fontWeight: FontWeight.bold,
  fontSize: 16,
  color: kWhiteTextColor,
);
...
const kProductReviewTextStyle = TextStyle(
  fontSize: 15,
  color: kGreyTextColor
);
...
const kProductRatingTextStyle = TextStyle(
  fontSize: 14,
  color: kWhiteTextColor,
  fontWeight: FontWeight.bold,
);
...
const kCurrentIndexTextStyle = TextStyle(
  color: kWhiteTextColor,
  fontWeight: FontWeight.bold,
);
